...
TRUNCATE TABLE users, brands, products, product_images, product_specs, 
               addresses, orders, order_items, news_categories, news, 
               reviews, review_images, review_helpful_votes, review_replies, 
               refresh_tokens, password_reset_tokens CASCADE;
...
('cccccccc-cccc-cccc-cccc-000000000001', 'c0000002-0000-0000-0000-000000000001', 'bbbbbbbb-bbbb-bbbb-bbbb-000000000004', 'Intel Core i9-14900K', 'i9-14900k', 'S1', 16000000, 15000000, 50, 36, '{"Socket": "LGA 1700", "Nhân/Luồng": "24C/32T", "Xung nhịp": "3.2GHz - 6.0GHz", "Bộ nhớ đệm": "36MB L3", "TDP": "125W"}', 2, NOW(), NOW()),
('cccccccc-cccc-cccc-cccc-000000000002', 'c0000002-0000-0000-0000-000000000001', 'bbbbbbbb-bbbb-bbbb-bbbb-000000000005', 'AMD Ryzen 9 7950X', 'r9-7950x', 'S2', 15000000, 14000000, 40, 36, '{"Socket": "AM5", "Nhân/Luồng": "16C/32T", "Xung nhịp": "4.5GHz - 5.7GHz", "Bộ nhớ đệm": "64MB L3", "TDP": "170W"}', 2, NOW(), NOW()),
('cccccccc-cccc-cccc-cccc-000000000003', 'c0000002-0000-0000-0000-000000000001', 'bbbbbbbb-bbbb-bbbb-bbbb-000000000001', 'ASUS ROG RTX 4090 OC', 'rtx-4090-rog', 'S3', 55000000, 52000000, 10, 36, '{"Nhân CUDA": "16384", "Bộ nhớ": "24GB GDDR6X", "Bus": "384-bit", "Nguồn yêu cầu": "850W", "Cổng xuất": "DP, HDMI"}', 2, NOW(), NOW()),
('cccccccc-cccc-cccc-cccc-000000000004', 'c0000002-0000-0000-0000-000000000001', 'bbbbbbbb-bbbb-bbbb-bbbb-000000000002', 'MSI RTX 4080 Suprim X', 'rtx-4080-msi', 'S4', 35000000, 33000000, 15, 36, '{"Nhân CUDA": "9728", "Bộ nhớ": "16GB GDDR6X", "Bus": "256-bit", "Nguồn yêu cầu": "750W", "Cổng xuất": "DP, HDMI"}', 2, NOW(), NOW()),
('cccccccc-cccc-cccc-cccc-000000000005', 'c0000002-0000-0000-0000-000000000001', 'bbbbbbbb-bbbb-bbbb-bbbb-000000000009', 'Corsair Dominator 32GB DDR5', 'ddr5-32', 'S5', 4500000, 4200000, 100, 36, '{"Loại": "DDR5", "Dung lượng": "32GB (2x16)", "Bus": "5600MHz", "Độ trễ": "CL36", "Led": "RGB"}', 2, NOW(), NOW()),
('cccccccc-cccc-cccc-cccc-000000000006', 'c0000002-0000-0000-0000-000000000001', 'bbbbbbbb-bbbb-bbbb-bbbb-000000000006', 'Samsung 990 Pro 1TB NVMe', '990-1tb', 'S6', 3500000, 3200000, 80, 60, '{"Chuẩn": "M.2 NVMe Gen4", "Dung lượng": "1TB", "Tốc độ đọc": "7450MB/s", "Tốc độ ghi": "6900MB/s", "Cache": "1GB LPDRR4"}', 2, NOW(), NOW()),
('cccccccc-cccc-cccc-cccc-000000000007', 'c0000002-0000-0000-0000-000000000001', 'bbbbbbbb-bbbb-bbbb-bbbb-000000000001', 'Laptop ROG Strix G16', 'g16', 'S7', 45000000, 42000000, 20, 24, '{"Màn hình": "16 inch 165Hz", "CPU": "i7-13650HX", "GPU": "RTX 4060", "RAM": "16GB DDR5", "SSD": "512GB PCIe"}', 2, NOW(), NOW()),
('cccccccc-cccc-cccc-cccc-000000000008', 'c0000002-0000-0000-0000-000000000001', 'bbbbbbbb-bbbb-bbbb-bbbb-000000000004', 'Intel Core i7-14700K', 'i7-14700k', 'S8', 11000000, 10500000, 60, 36, '{"Socket": "LGA 1700", "Nhân/Luồng": "20C/28T", "Xung nhịp": "3.4GHz - 5.6GHz", "Bộ nhớ đệm": "33MB L3", "TDP": "125W"}', 2, NOW(), NOW()),
('cccccccc-cccc-cccc-cccc-000000000009', 'c0000002-0000-0000-0000-000000000001', 'bbbbbbbb-bbbb-bbbb-bbbb-000000000010', 'G.Skill Trident Z5 32GB', 'z5-32', 'S9', 4800000, 4500000, 50, 36, '{"Loại": "DDR5", "Dung lượng": "32GB (2x16)", "Bus": "6000MHz", "Độ trễ": "CL30", "Led": "RGB"}', 2, NOW(), NOW()),
('cccccccc-cccc-cccc-cccc-000000000010', 'c0000002-0000-0000-0000-000000000001', 'bbbbbbbb-bbbb-bbbb-bbbb-000000000009', 'Nguồn Corsair RM850x', 'rm850x', 'S10', 3500000, 3200000, 40, 120, '{"Công suất": "850W", "Chứng nhận": "80 Plus Gold", "Kiểu": "Full Modular", "Kích thước": "ATX", "Bảo hành": "10 năm"}', 2, NOW(), NOW());
...
-- 5. SEED PRODUCT SPECS (10)
INSERT INTO product_specs (spec_id, product_id, spec_key, spec_value, created_at) VALUES 
('eeeeeeee-eeee-eeee-eeee-000000000001', 'cccccccc-cccc-cccc-cccc-000000000001', 'Xung nhịp', '5.8GHz', NOW()),
('eeeeeeee-eeee-eeee-eeee-000000000002', 'cccccccc-cccc-cccc-cccc-000000000002', 'Số nhân', '16 Cores', NOW()),
('eeeeeeee-eeee-eeee-eeee-000000000003', 'cccccccc-cccc-cccc-cccc-000000000003', 'VRAM', '24GB', NOW()),
('eeeeeeee-eeee-eeee-eeee-000000000004', 'cccccccc-cccc-cccc-cccc-000000000004', 'Led', 'RGB', NOW()),
('eeeeeeee-eeee-eeee-eeee-000000000005', 'cccccccc-cccc-cccc-cccc-000000000005', 'Dung lượng', '32GB', NOW()),
('eeeeeeee-eeee-eeee-eeee-000000000006', 'cccccccc-cccc-cccc-cccc-000000000006', 'Tốc độ đọc', '7450MB/s', NOW()),
('eeeeeeee-eeee-eeee-eeee-000000000007', 'cccccccc-cccc-cccc-cccc-000000000007', 'Màn hình', '16 inch QHD', NOW()),
('eeeeeeee-eeee-eeee-eeee-000000000008', 'cccccccc-cccc-cccc-cccc-000000000008', 'Thế hệ', 'Gen 14', NOW()),
('eeeeeeee-eeee-eeee-eeee-000000000009', 'cccccccc-cccc-cccc-cccc-000000000009', 'Độ trễ', 'CL30', NOW()),
('eeeeeeee-eeee-eeee-eeee-000000000010', 'cccccccc-cccc-cccc-cccc-000000000010', 'Công suất', '850W', NOW());
...
-- 8. SEED ORDERS (10)
INSERT INTO orders (order_id, user_id, order_code, total_amount, status, payment_method, shipping_address_id, created_at, updated_at) VALUES 
('eeeeeeee-eeee-eeee-eeee-000000000001', 'aaaaaaaa-aaaa-aaaa-aaaa-000000000003', 'ORD-001', 70000000, 5, 'VNPAY', 'dddddddd-dddd-dddd-dddd-000000000001', NOW(), NOW()),
('eeeeeeee-eeee-eeee-eeee-000000000002', 'aaaaaaaa-aaaa-aaaa-aaaa-000000000004', 'ORD-002', 10500000, 1, 'COD', 'dddddddd-dddd-dddd-dddd-000000000002', NOW(), NOW()),
('eeeeeeee-eeee-eeee-eeee-000000000003', 'aaaaaaaa-aaaa-aaaa-aaaa-000000000005', 'ORD-003', 42000000, 5, 'BANK', 'dddddddd-dddd-dddd-dddd-000000000003', NOW(), NOW()),
('eeeeeeee-eeee-eeee-eeee-000000000004', 'aaaaaaaa-aaaa-aaaa-aaaa-000000000006', 'ORD-004', 3200000, 4, 'VNPAY', 'dddddddd-dddd-dddd-dddd-000000000004', NOW(), NOW()),
('eeeeeeee-eeee-eeee-eeee-000000000005', 'aaaaaaaa-aaaa-aaaa-aaaa-000000000007', 'ORD-005', 14000000, 2, 'COD', 'dddddddd-dddd-dddd-dddd-000000000005', NOW(), NOW()),
('eeeeeeee-eeee-eeee-eeee-000000000006', 'aaaaaaaa-aaaa-aaaa-aaaa-000000000008', 'ORD-006', 33000000, 3, 'BANK', 'dddddddd-dddd-dddd-dddd-000000000006', NOW(), NOW()),
('eeeeeeee-eeee-eeee-eeee-000000000007', 'aaaaaaaa-aaaa-aaaa-aaaa-000000000009', 'ORD-007', 9000000, 5, 'VNPAY', 'dddddddd-dddd-dddd-dddd-000000000007', NOW(), NOW()),
('eeeeeeee-eeee-eeee-eeee-000000000008', 'aaaaaaaa-aaaa-aaaa-aaaa-000000000010', 'ORD-008', 3500000, 5, 'BANK', 'dddddddd-dddd-dddd-dddd-000000000008', NOW(), NOW()),
('eeeeeeee-eeee-eeee-eeee-000000000009', 'aaaaaaaa-aaaa-aaaa-aaaa-000000000003', 'ORD-009', 15000000, 5, 'VNPAY', 'dddddddd-dddd-dddd-dddd-000000000001', NOW(), NOW()),
('eeeeeeee-eeee-eeee-eeee-000000000010', 'aaaaaaaa-aaaa-aaaa-aaaa-000000000004', 'ORD-010', 4800000, 5, 'COD', 'dddddddd-dddd-dddd-dddd-000000000002', NOW(), NOW());
...
('ffffffff-ffff-ffff-ffff-000000000001', 'eeeeeeee-eeee-eeee-eeee-000000000001', 70000000, 'VNPAY', 2, NOW()),
('ffffffff-ffff-ffff-ffff-000000000002', 'eeeeeeee-eeee-eeee-eeee-000000000002', 10500000, 'COD', 1, NULL),
('ffffffff-ffff-ffff-ffff-000000000003', 'eeeeeeee-eeee-eeee-eeee-000000000003', 42000000, 'BANK', 2, NOW()),
('ffffffff-ffff-ffff-ffff-000000000004', 'eeeeeeee-eeee-eeee-eeee-000000000004', 3200000, 'VNPAY', 2, NOW()),
('ffffffff-ffff-ffff-ffff-000000000005', 'eeeeeeee-eeee-eeee-eeee-000000000005', 14000000, 'COD', 1, NULL),
('ffffffff-ffff-ffff-ffff-000000000006', 'eeeeeeee-eeee-eeee-eeee-000000000006', 33000000, 'BANK', 2, NOW()),
('ffffffff-ffff-ffff-ffff-000000000007', 'eeeeeeee-eeee-eeee-eeee-000000000007', 9000000, 'VNPAY', 2, NOW()),
('ffffffff-ffff-ffff-ffff-000000000008', 'eeeeeeee-eeee-eeee-eeee-000000000008', 3500000, 'BANK', 2, NOW()),
('ffffffff-ffff-ffff-ffff-000000000009', 'eeeeeeee-eeee-eeee-eeee-000000000009', 15000000, 'VNPAY', 2, NOW()),
('ffffffff-ffff-ffff-ffff-000000000010', 'eeeeeeee-eeee-eeee-eeee-000000000010', 4800000, 'COD', 2, NOW());

-- 11. SEED NEWS CATEGORIES (10)
